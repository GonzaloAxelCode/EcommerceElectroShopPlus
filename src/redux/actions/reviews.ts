...
export const get_reviews = (product_id: number) => async (dispatch: any) => {
  const config = {
    headers: {
...
export const get_review = (product_id: number) => async (dispatch: any) => {
...
export const delete_review = (product_id: number) => async (dispatch: any) => {
  if (localStorage.getItem("access")) {
    const config = {
      headers: {
        Authorization: `JWT ${localStorage.getItem("access")}`,
...
export const filter_reviews =
  (product_id: number, rating: number) => async (dispatch: any) => {
    const config = {
      headers: {
        Accept: "application/json",
      },
